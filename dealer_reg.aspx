					...
					<div class="form-w3agile">
						<h3>
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="width: 258px;height:80px;"><asp:TextBox ID="dname" runat="server" Height="25px" Width="233px" placeholder="Company name"></asp:TextBox></td>
                            </tr><br>
                            <tr>
                            ...
                            <tr>
                                <td class="text-left"><i class="fa fa-globe" aria-hidden="true"></i></td>
                                <td class="text-left" style="width: 258px;height:80px;"><asp:TextBox ID="loc" runat="server" Height="25px" Width="233px" placeholder="location"></asp:TextBox></td>
                            ...
                            <tr>
                                ...
                                <td class="text-left" style="width: 258px;height:80px;"><asp:Label runat="server" Text="Company icon"></asp:Label></td>
